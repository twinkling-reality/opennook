...
| Companions | add, remove, and reorder; placement, style, and details of the selected one | `addCompanion(...)` |
...
- The playground's own views appear as placeholders - `MyHomeView`, `ActionPill`,
  `RoundButton`, `ChromeControls`, `StatusChip`, `HeaderTitle`, `HeaderButtons` - for
  you to replace with yours.
